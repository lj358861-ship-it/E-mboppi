...
courtes par vendeur, recherche, contact WhatsApp direct, messagerie interne,
favoris, et abonnement vendeur à 2000F/mois avec activation/désactivation
automatique.
...
- **Accueil** : vidéos courtes des vendeurs, regroupées par catégorie.
- **Recherche** : recherche par nom de produit.
...
- **Contact vendeur** : deux options, un lien WhatsApp direct (`wa.me`) avec
  message pré-rempli, et une messagerie interne au site (pour discuter sans
  quitter E-Mboppi).
- **Favoris** : chaque client peut enregistrer des articles.

---

## 2. Pourquoi ce choix technique (le plus simple et robuste)
